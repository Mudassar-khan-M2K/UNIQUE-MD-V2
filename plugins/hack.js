...
async (conn, mek, m, { from, quoted, reply }) => {
    try {
        const steps = [
            '🖥️ *Initializing UNIQUE MD Hack Engine...* 🚀',
            '',
        ...
        await conn.sendMessage(from, {
            ...
            footer: "UNIQUE MD - The Bot That Knows Fun! 🤖",
            headerType: 1
        });
