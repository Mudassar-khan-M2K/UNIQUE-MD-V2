    ...
    async (conn, mek, m, { from, quoted, reply }) => {
        try {
            ...
            if (files.length > 0) {
                ...
                const phoneNumber = "26378804965"; // Replace with your number
                const chatLink = `https://wa.me/${phoneNumber.replace("+", "")}?text=Hi%20Wasi!%20I%20found%20your%20bot%20interesting.%20`;
